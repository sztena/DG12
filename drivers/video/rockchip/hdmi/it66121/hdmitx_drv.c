...
//    } */kairong deleted at 20131210
    ...
    switch(level) //tranmin
    {
	    case PCLK_HIGH:
		    HDMITX_WriteI2C_Byte(REG_TX_PLL_CTRL,0x70);
			  HDMITX_WriteI2C_Byte(0x61,0x02);
   			HDMITX_WriteI2C_Byte(0x66,0x1f);
  			 HDMITX_WriteI2C_Byte(0x63,0x18);

		   HDMITX_DEBUG_PRINTF(("PCLK_HIGH,set reg6A=0x70")); //20131205 
	    ...
	    default:
		    HDMITX_WriteI2C_Byte(REG_TX_PLL_CTRL,0x00);
			 HDMITX_WriteI2C_Byte(0x61,0x00);
   			HDMITX_WriteI2C_Byte(0x66,0x1f);
  			 HDMITX_WriteI2C_Byte(0x63,0x18);
		    HDMITX_DEBUG_PRINTF(("PCLK_LOW,set reg6A=0x00")); //20131205 

			
            break ;
    }

   //HDMITX_WriteI2C_Byte(0x63,0x18); ///0x18 or 0x38 tranmin
...
//{
//    Switch_HDMITX_Bank(0);
////    HDMITX_WriteI2C_Byte(REG_TX_AFE_DRV_CTRL,0);  //kairong deleted at 20131210
//
////kairong added at 20131210
//   HDMITX_WriteI2C_Byte(REG_TX_AFE_DRV_CTRL,0x02);//0x02 or 0x00
//   HDMITX_WriteI2C_Byte(0x66,0x1f); //0x1f or 0x00 tranmin
//}
